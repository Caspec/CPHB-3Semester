    ...
    fetch("api/person/all", {method: "get"})
            ...
            .then(function (json) {
                ...
                for (var i in json)
                {
                    ...
                    rows += '<td><input type="button" id="PersonDelete" onclick="PersonDelete(' + json[i].id + ')" value="Delete" /></td>';
                    rows += '<td><input type="button" id="PersonEdit" onclick="PersonSendEdit(' + json[i].id + ')" value="Edit" /></td>';
