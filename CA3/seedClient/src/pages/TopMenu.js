      ...
      <img src="/bears.png"/>
        <nav className="navbar navbar-default" >
          ...
          <div className="container-fluid">
            ...
            {!this.state.loggedIn && (<li><Link to="/registeruser">Register User</Link></li>)}
            <li><Link to="/allplaces">All places</Link></li>
            <li><Link to="/place">Place</Link></li>
            {this.state.loggedIn && this.state.isUser && (<li><Link to="/createplace">Create place </Link></li>)}
